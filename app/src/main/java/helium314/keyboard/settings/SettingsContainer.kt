...
import helium314.keyboard.settings.screens.createWhisperSettings
...
private fun createSettings(context: Context) = createAboutSettings(context) + createAppearanceSettings(context) +
        ...
        createLayoutSettings(context) + createAdvancedSettings(context) + createWhisperSettings(context) +
